...
const zaehler = (e) => {
  ...
  if (e.kategorie === 'support') return e.ueber_kontingent ? 'über Kontingent' : 'im Kontingent';
...
export default function Buchungsliste({ auswertung, eintraege, projektLabel, gesperrt, onAendern, onLoeschen }) {
        ...
        return (
          <div key={e.id} className="flex items-center gap-3 px-3 py-2.5">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              {e.verrechenbar === false
                ? <Etikett farbe={STATUS_COLORS.attention} flaeche={STATUS_COLORS.attentionSurface}>nicht verrechenbar</Etikett>
                : <Etikett farbe={STATUS_COLORS.doneText} flaeche={STATUS_COLORS.doneSurface}>verrechenbar</Etikett>}
