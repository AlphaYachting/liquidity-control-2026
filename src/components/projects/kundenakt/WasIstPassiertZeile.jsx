...
// Ein Satz aus der Kontextzone: entweder direkt festhalten oder vom Modell ordnen lassen.
export default function WasIstPassiertZeile({ onFesthalten, onStrukturieren }) {
