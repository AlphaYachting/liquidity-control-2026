...
- WEBSITE-FORMULAR-ANFRAGEN sind NEUE KUNDENANFRAGEN mit Handlungsbedarf: E-Mails vom eigenen Kontaktformular (Merkmale: "Hurra! Die Post ist da", "Schön von Ihnen zu lesen", strukturierte Felder Name/E-Mail/Telefon/Nachricht) — auch wenn sie von der eigenen Adresse (office@rittler.co) kommen, denn das Formular versendet über diese Adresse. Solche Threads: category "anforderung_change", status "offen", summary mit den Kerndaten der Anfrage (wer, was wird angefragt). NIEMALS als "Intern/System" oder "erledigt" einstufen.
